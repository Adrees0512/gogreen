...
// const AnyReactComponent = ({ lat,lng,text }) => <div><h3 onClick={()=>func(lat,lng,text)}><i class="fa fa-tree"></i></h3></div>;


// function func(lat,lng,text){
//   console.log("lat,lng,text",lat,lng,text);
