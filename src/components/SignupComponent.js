          ...
          <div className='Signupbox'>
            ...
            <Row className='form-group'>
              ...
              <Row className='form-group'>
                ...
                <Col >
                    <Input  model=".email" id="email1" name="email" value={email} type='email' placeholder="Your Email" className="form-control" onChange={this.changeHandler} onBlur={this.handleBlur('email')}
              ...
              <Row className='form-group'>
                <Col >
                  <Input  model=".password" id="password1" name="password" value={password} type='password' placeholder="Password" className="form-control" onChange={this.changeHandler} onBlur={this.handleBlur('password')}
